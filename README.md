...
## How to Install
1. Go to the [Releases](https://github.com/Atoryx1s/AppPanell/releases/tag/v1.1.0).
2. Download the `AppPanell_1.1.0_x64_en-US.msi` or `AppPanell_1.1.0_x64-setup.exe` file.
